...
-- dap.defaults.node.terminal_win_cmd = "tabnew"
...
---- Dap Tab Layout
---
-- Table to store buffer references for each tab
--
-- Table to store buffer references for each tab type
-- Function to move DAP buffers to a separate tab
